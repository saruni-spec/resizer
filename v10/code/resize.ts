...
export class resizer extends view {
  ...
  constructor(
    ...
    this.panels = new Map();
    //
    // if a grid contaibner is provided,use its width and height instead of the window width and height
    if (grid_container) {
      this.viewport = [grid_container.clientWidth, grid_container.clientHeight];
    }
    //
